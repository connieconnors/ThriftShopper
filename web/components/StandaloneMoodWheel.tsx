...
const categories = {
  ...
  Intents: [
    ...
    { name: 'Indulgence', icon: User, color: '#8C7BAF', description: 'Treat yourself' },
    { name: 'Practical', icon: Sofa, color: '#C28A3B', description: 'Style your space' },
    { name: 'Collectibles', icon: Archive, color: '#7B4C7A', description: 'For collectors' },
    { name: 'Accessorize', icon: Heart, color: '#B4475B', description: 'Meaningful items' },
    { name: 'Celebrate', icon: Package, color: '#5776A5', description: 'Practical use' },
    { name: 'Homestyle', icon: Utensils, color: '#B38A63', description: 'Cook & serve' },
    { name: 'Dine In', icon: Lamp, color: '#C28A3B', description: 'Living room finds' },
  ],
  Styles: [
